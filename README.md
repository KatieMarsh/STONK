...
It work by using LSTM sotck predictor model [Original](https://github.com/datawiz-thailand/tutorials) and stock indicator(well, so much for that xD) to predict the stock price on close.
